...
export default memo(({ post }) => {
    ...
    const { _id: postId, userId: postUserId, likes, image, firstName, lastName, userImageUrl, comments } = post
    ...
    const { isLiked, 
        ...
        isMine, 
        isSaved, 
        onClickSave } = usePost({ postId, postUserId, likes })

    const [showModal, toggleShowModal] = useToggle(false)
    const openModal = useCallback(() => toggleShowModal(true), [])
