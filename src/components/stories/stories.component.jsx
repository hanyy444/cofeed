...
import { selectAuthUser, userApi } from 'redux/slices/auth.slice';
...
const Stories = () => {
    ...
    const friends = useQuery({
        ...
        thunk: { action: userApi.getUserFriends, params: { path: `${user?._id}/friends` } }
    })

    const renderedStories = [user, ...friends]
